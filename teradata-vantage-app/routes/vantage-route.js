module.exports = (app) => {
  ...
  app.get("/api/databases", vantageController.getDatabases); //Nothing has been saved into session
  app.get("/api/databases/:database/tables", vantageController.getTables); //Nothing has been saved into session
  app.get("/api/databases/:database/tables/:table/columns", vantageController.getColumns);//Saving list_of_all_columns in session
